  ...
  return (
    ...
    >
      <img
        src={img}
        alt=""
        className="w-full my-10 flex flex-col gap-5 sm:w-80 sm:h-80 lg:w-96 lg:h-96 xl:w-[28rem] xl:h-[28rem] border-4 border-orange"
      />
      <div>
        <div>
          ...
          <h2 className=" text-ash text-2xl font-bold sm:text-lg lg:text-3xl xl:text-4xl">
            {title}
          </h2>
        </div>
