...
const Dropdown = ({handleAcceptModal, handleDeclineModal}) => {
  ...
  return (
    ...
    <div className="relative">
      ...
      {open && <div className="bg-white w-28 h-20 mx-auto shadow-lg flex flex-col justify-center px-3 py-2 gap-y-2 rounded-md absolute top-12 z-40 ">
        <p onClick={handleAcceptModal} className="text-green-500 cursor-pointer">Accept</p>
         {/* {location === "virtual" &&  */}
          <p className="text-btnMaroon cursor-pointer">Join virtual</p>
          {/* // } */}
